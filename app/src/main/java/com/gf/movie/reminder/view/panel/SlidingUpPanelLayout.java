package com.gf.movie.reminder.view.panel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Flag indicating that on drag view clicks should trigger collapse/expand when sliding feature is enabled\disabled
     */
    private boolean mIsOnClickSlideEnabledWhenSlidingDisabled;
    /**
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.img_shadow_top);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.img_shadow_bottom);
            }
    ...
    public boolean isOnClickSlideEnabledWhenSlidingDisabled() {
        return mIsOnClickSlideEnabledWhenSlidingDisabled;
    }

    /**
     * Set onClick dragview sliding enabled flag
     *
     * @param enabled flag value
     */
    public void setOnClickSlideEnabledWhenSlidingDisabled(boolean enabled) {
        mIsOnClickSlideEnabledWhenSlidingDisabled = enabled;
    }
    ...
    boolean smoothSlideTo(float slideOffset, int velocity) {
        if (!isSlidingEnabled() && !mIsOnClickSlideEnabledWhenSlidingDisabled) {
            // Nothing to do.
            return false;
        }

        if (mIsOnClickSlideEnabledWhenSlidingDisabled) {
            mIsSlidingEnabled = true;
        }
