...
public class GameTrailersFragment extends BaseFragment implements Callback<ArrayList<Game>>,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (!mIsSelectingNewReminder) {
            if (Utils.isTrailerPanelEnabled(mPrefs)) {
                ...
                mGameTrailerTopDragFragment.updateWithGame((Game) mAdapter.getItem(position));
                mGameTrailerBottomDragFragment.updateWithGame((Game) mAdapter.getItem(position));
                ...
                intent.putExtra(GameTrailerActivity.EXTRA_GAME, mAdapter.getItem(position));
            ...
            mNotificationManager.registerNewGameNotification(getActivity().getApplicationContext(), (Game) mAdapter.getItem(position));
        }
    }
