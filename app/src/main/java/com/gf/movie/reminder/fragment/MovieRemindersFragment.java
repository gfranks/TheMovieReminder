...
public class MovieRemindersFragment extends BaseFragment implements AdapterView.OnItemClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (Utils.isTrailerPanelEnabled(mPrefs)) {
            ...
            mMovieTrailerTopDragFragment.updateWithReminder(((MovieReminder) mAdapter.getItem(position)));
            mMovieTrailerBottomDragFragment.updateWithReminder(((MovieReminder) mAdapter.getItem(position)));
