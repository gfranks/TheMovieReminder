package com.gf.movie.reminder.view.pulltorefresh;
...
public class PullToRefreshLayout extends ViewGroup {
    ...
    public PullToRefreshLayout(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.PullToRefreshLayout_type, STYLE_MATERIAL);
        final int colorsId = a.getResourceId(R.styleable.PullToRefreshLayout_colors, R.array.pull_to_refresh_colors);
        a.recycle();
        ...
        if (Utils.isAtLeastLollipop()) {
            mRefreshView.setElevation(getResources().getDimensionPixelSize(R.dimen.shadow_elevation));
        }
    }
